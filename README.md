...
> Portal sagrado de Oráculos, Leitura de Cartas, Tarô, Baralho Cigano, Numerologia Pessoal, Interpretação de Sonhos e Diário Astral.

![Preview](https://buscadora-astral.vercel.app/assets/hero_bg.jpg)

---

## 🌟 Funcionalidades do Projeto

- 📜 **Design Medieval & Místico**: Estética envolvente com pergaminho rústico, poeira estelar interativa e acabamentos dourados.
- 🔮 **Paleta da Numerologia**: Harmonia de Violeta, Vinho, Coral, Branco e Dourado.
- 🌙 **Widget Lunar em Tempo Real**: Calcula e exibe a fase atual da lua e as energias astrais do dia.
...
- **HTML5 & CSS3** Moderno (Vanilla CSS com Design System de Variáveis)
- **JavaScript ES6+** Puro (Modular, leve e de alta performance)
- **HTML5 Canvas** (Animações de constelações e poeira estelar)
